...
const AddArtis = () => {
  ...
  const handleAddArtis = async () => {
    ...
    setAlert({message : 'Artis Added', variant : 'danger'});
  };
  return(
    <>
      <Container fluid style = {{backgroundColor : "#161616", minHeight : '90vh'}} className = "p-5">
        ...
        <Form.Control style = {{backgroundColor : 'rgba(210, 210, 210, 0.25)', color : 'rgba(210, 210, 210, 1)',marginBottom : 20}} type="text" placeholder="Old" onChange = {(e) => setInputs({...inputs,old : e.target.value})}/>
        <Form.Select style = {{backgroundColor : 'rgba(210, 210, 210, 0.25)', color : 'rgba(210, 210, 210, 1)',marginBottom : 20}} onChange = {(e) => setInputs({...inputs,type : e.target.value})}>
          <option style={{backgroundColor : 'grey', color : 'white'}}>Choose</option>
        ...
        <Form.Control style = {{backgroundColor : 'rgba(210, 210, 210, 0.25)', color : 'rgba(210, 210, 210, 1)',marginBottom : 20}} type="text" placeholder="Start Carrer" onChange = {(e) => setInputs({...inputs,startCarrer : e.target.value})}/>
